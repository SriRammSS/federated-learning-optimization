...
This section records 12 rounds of structured self-critique applied to the
previous draft. Each pass names concrete issues, then documents the revisions
that followed. The goal is substantive correction rather than style cleanup:
for example, Reviewer 4 demoted CVaR-$0$'s headline ``best worst-recall'' to a
footnote because of seed variance, and Reviewer 7 forced us to qualify the
LP--Pareto agreement story.
