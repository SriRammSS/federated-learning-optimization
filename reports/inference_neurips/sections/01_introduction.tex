...
\end{itemize}
This report synthesizes both artefact families. It contributes five pieces of
analysis that are useful for interpreting the experimental results:
\begin{enumerate}[leftmargin=*,topsep=2pt]
    ...
    \item \textbf{Structured self-critique.} Section~\ref{sec:critique}
        contains $12$ review passes with logged edits. Each pass records the
        issues found in the previous draft and the specific revisions that
        followed.
...
Section~\ref{sec:critique} records the self-critique and revisions.
Section~\ref{sec:tables-turned} reports the counterfactual rankings. Section~\ref{sec:limits}
