...
Four findings dominate. \textbf{(i)} \fedprox{} with $\mu \!=\! 0.1$ outperforms SOFA-LR on both \auroc{} (+0.161) and \auprc{} (+0.359), providing the strongest argument for clinical utility. On 30 uncontaminated seeds, FedProx-0.1 attains global $\auprc \!=\! 0.665 \pm 0.005$ and worst-client recall $0.513 \pm 0.049$ (95\% CI: $[0.495, 0.531]$). The fairness metric winner depends on which metric is used: on \emph{worst-client} \auprc{}, FedProx-0.01 leads (0.345 vs.\ 0.331 for $\mu\!=\!0.1$); on worst-client recall, FedProx-0.1 leads. We report both metrics side by side throughout. \textbf{(ii)}
