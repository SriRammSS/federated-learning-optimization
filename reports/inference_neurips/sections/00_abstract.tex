...
Three findings dominate. \textbf{(i)} \fedprox{} with $\mu \!=\! 0.1$ is the
single best-balanced method on natural clients, attaining
$\auprc \!=\! 0.665 \pm 0.005$, $\auroc \!=\! 0.913 \pm 0.001$, and worst-client
recall $0.50 \pm 0.05$, while spending $\sim$25\% \emph{less} communication than
\fedavg{}. The convex logistic backbone reproduces the same $\mu \!=\! 0.1$ winner
($\auprc \!=\! 0.612 \pm 0.007$, paired-$t$ effect size $+1.03$ vs.\ \fedavg{}),
demonstrating the result is not an MLP non-convexity artefact. \textbf{(ii)}
