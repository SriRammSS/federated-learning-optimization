...
This section is the report's stress test. We rerun the central narrative under
$10$ counterfactual rankings and report which conclusions survive. ``Tables
turned'' = ranking by an axis we previously deprioritised. If a finding only
held under our preferred axis, it is fragile; if it survives all $10$
rotations, it is robust.
